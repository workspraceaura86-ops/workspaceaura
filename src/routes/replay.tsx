...
const session: Moment[] = [
  {
    ...
    reading: { distance: 68, light: 420, temperature: 21.5, humidity: 47 },
    focus: null,
  },
  {
    time: "10:00",
    ...
    reading: { distance: 66, light: 450, temperature: 22, humidity: 46 },
    focus: null,
  },
  {
    time: "11:15",
    ...
    reading: { distance: 42, light: 430, temperature: 22.5, humidity: 45 },
    focus: "distance",
  },
  {
    time: "12:30",
    ...
    reading: { distance: 44, light: 610, temperature: 25.6, humidity: 36 },
    focus: "temperature",
  },
  {
    time: "13:10",
  ...
  },
  {
    ...
    reading: { distance: 58, light: 90, temperature: 23.4, humidity: 41 },
    focus: "light",
  },
  {
    time: "16:00",
    ...
    reading: { distance: 60, light: 390, temperature: 23, humidity: 42 },
    focus: "light",
  },
  {
    time: "17:30",
    ...
    reading: { distance: 65, light: 360, temperature: 22.6, humidity: 40 },
    focus: null,
  },
];
